...
export default async function BuyersPage({ searchParams }: { searchParams?: Record<string,string> }) {
  ...
  const where: any = {};
  // simple filters via querystring
  ...
  return (
    <div>
      ...
      <div style={{ marginBottom: 12 }}>
        <Link href="/buyers/new">+ New Lead</Link> | <a href="/api/buyers/export">Export CSV</a> | <Link href="/buyers/import">Import CSV</Link>
      </div>
      <table border={1} cellPadding={6}>
        <thead><tr>
          <th>Name</th><th>Phone</th><th>City</th><th>Property</th><th>Budget</th><th>Timeline</th><th>Status</th><th>UpdatedAt</th><th>Actions</th>
        </tr></thead>
        <tbody>
          {buyers.map(b => (
            <tr key={b.id}>
